...
$(document).ready(function() {
    ...
    var ctx = document.getElementById('proj-status1').getContext("2d");
    ...
    var ctx = document.getElementById('proj-status2').getContext("2d");
    var myChart = new Chart(ctx, {
        type: 'pie',
        data: {
            datasets: [{
    ...
    var ctx = document.getElementById('proj-status3').getContext("2d");
    var myChart = new Chart(ctx, {
        type: 'pie',
        data: {
            datasets: [{
