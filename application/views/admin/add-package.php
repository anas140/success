            ...
            ?>
                                    ...
                                    <div class="page-body">
                                        <div class="row" style="margin-top: -74px;">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                       <h4 class="box-title" style="color:#448aff";>View Package</h4>
                                                        <span></span>
                                                    </div>
                                                    <div class="card-block">
                    ...
                    ?>
																...
																<td><?php echo $i;?></td>
																   ...
																   <td><?php echo anchor('admin/home/package_edit/' .$post->package_id, 'edit'); ?>
																    <a data-toggle="modal" href="#Delete_Log" class="delete_option " data-id="<?php echo $post->package_id;?>">delete</a>
																   </td>
																</tr>
